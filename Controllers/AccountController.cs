...
using ProjectMusicLibrary.Models.AccountViewModels;
using ProjectMusicLibrary.Services;

namespace ProjectMusicLibrary.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            try
            {
                ...
                {
                    serviceResult.Messages.Add("Error while saving a user");
                    serviceResult.Messages.Add(ModelState.ToString());
                }
            ...
            {
                serviceResult.Success = false;
                serviceResult.Messages.Add("Internal Server Error");
                serviceResult.Messages.Add(ex.Message);
            }
